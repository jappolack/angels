...
--
-- Host: localhost:3306
-- Generation Time: Nov 02, 2022 at 05:17 PM
...
CREATE TABLE `dbevents` (
  `id` int(255) UNSIGNED NOT NULL DEFAULT '1' COMMENT 'poop',
  `name` text,
  `description` text,
  `address` text,
  `state` text,
...
INSERT INTO `dbevents` (`id`, `name`, `description`, `address`, `state`, `city`, `zip`) VALUES
(1, 'eventExample', 'example of an event', '123 your mom street', 'MI', 'nowhere', 69000);
